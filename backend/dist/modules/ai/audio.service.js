...
class AudioService {
     ...
     */
    async transcribeBase64(base64Audio, mimetype = 'audio/ogg') {
        try {
            ...
            if (!groqKey && !openAiKey) {
                console.warn('⚠️ [AudioService] Nenhuma chave GROQ_API_KEY ou OPENAI_API_KEY configurada para transcrição de áudios.');
